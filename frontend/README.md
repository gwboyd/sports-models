...
Current-picks pages treat results as supplemental data, so they still render ungraded picks if that request temporarily
fails; the dedicated results pages continue to surface non-404 upstream failures.
