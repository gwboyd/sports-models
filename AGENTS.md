...
Finalized markets must state their bet-relative outcome accessibly in text, including how many points the pick won or
lost by or that it pushed. Remove pregame-only detail from final favorite and lock surfaces while retaining model
projection context in expandable or hover details.
